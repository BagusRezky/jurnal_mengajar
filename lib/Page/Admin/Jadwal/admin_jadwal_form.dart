...
class AdminJadwalForm extends StatefulWidget {
  ...
  const AdminJadwalForm({super.key, required this.updateCallback});
...
class _AdminJadwalFormState extends State<AdminJadwalForm> {
  ...
  final TextEditingController ctt = TextEditingController();
                                  ...
                                  child: DropdownButton(
                                    ...
                                    items: itemsJam.map((item) {
                                      return DropdownMenuItem(
                                        ...
                                        child: Text(item['jam_ke'].toString()),
                                      );
                                    }).toList(),
                                    style: const TextStyle(
                                      color: Color(0xff000000),
                      ...
                      children: [
                        Obx(
                          () => Checkbox(
                            onChanged: (value) {
                              isAktif.value =
                                  !isAktif.value; // Update the checkbox state
                            },
