...
class AdminJadwalMingguanForm extends StatefulWidget {
  final VoidCallback updateCallback;
  const AdminJadwalMingguanForm({Key? key, required this.updateCallback})
      : super(key: key);

  @override
  State<AdminJadwalMingguanForm> createState() =>
      _AdminJadwalMingguanFormState();
}

class _AdminJadwalMingguanFormState extends State<AdminJadwalMingguanForm> {
  ...
  Future<void> createJadwalMingguan() async {
    ...
    final url =
        ...
        Uri.parse(
            'https://jurnalmengajar-1-r8590722.deta.app/jadwalmingguan-tambah/');
