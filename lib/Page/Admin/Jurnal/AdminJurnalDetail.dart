...
class _AdminJurnalDetailState extends State<AdminJurnalDetail> {
  ...
  Future<void> updateValidasi(String periodeId) async {
    ...
    final url = Uri.parse(
        ...
        'https://jurnalmengajar-1-r8590722.deta.app/jurnal-validasi/${widget.jurnalId}?tenant_id=$tenant');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print('Update validasi berhasil');
                  ...
                  child: TextButton(
                    ...
                    onPressed: isLoading
                        ...
                        : () {
                            ...
                            updateValidasi(widget.jurnalId);
                          },
